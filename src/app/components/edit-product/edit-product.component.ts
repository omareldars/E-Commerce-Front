...
get category(){
  ...
  constructor(private myActivated : ActivatedRoute, private myCategory: CategoryService, private router :Router, private myproduct: ProductService) 
  {
  ...
  collection(){
    ...
    this.myproduct.editProduct(this.id,this.editproduct.value).subscribe(
        (res)=>{console.log(res);console.log("pppppppppppppppppppppppp",this.product);console.log("eeeeeeeeeeeeeeeeeeeee",this.editproduct.value);},
